...
# ----------------------------------------------------
    ...
    if st.session_state.log_selecionado is not None:
        ...
        sst.info("👈 Utilize o menu lateral esquerdo para carregar um Arquivo de log local ou explore a opção \"LOG's da Comunidade\". <br>Acesse através do Computador para uma melhor visualização.")
